...
class Version20210521163106 extends Version {

	protected $description = "Добавлен ИБ \"Видео\"";
	...
	public function up()
	{
		...
		$iblockId = $helper->Iblock()->saveIblock(array(
				...
				'DETAIL_PAGE_URL'	 => '#SITE_DIR#/videos/#ELEMENT_CODE#/',
				'SECTION_PAGE_URL'	 => '',
				'CANONICAL_PAGE_URL' => '',
				'PICTURE'			 => NULL,
				'DESCRIPTION'		 => '',
		...
		$helper->UserOptions()->saveElementForm($iblockId,
			array(
				...
				array(
						...
						'PROPERTY_YOUTUBE_ID'	 => 'Идентификатор Youtube',
						'PROPERTY_IS_HIGHLIGHT'	 => 'Хайлайт',
				...
				array(
						...
						array(
								...
								array(
										...
										4	 => 'TIMESTAMP_X',
										5	 => 'ID',
										6	 => 'PROPERTY_TOURNAMENT',
										7	 => 'PROPERTY_YOUTUBE_ID',
										8	 => 'PROPERTY_IS_HIGHLIGHT',
								),
								'columns_sizes'		 =>
								array(
										'expand'	 => 1,
