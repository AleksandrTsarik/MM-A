...
class Version20210521162439 extends Version {

	protected $description = "Добавлен ИБ \"Баннеры\" (ru)";
		...
		$helper->UserOptions()->saveElementForm($iblockId,
			array(
				...
				array(
						...
						'NAME'				 => 'Название (любое)',
						'SORT'				 => 'Сортировка',
						'DETAIL_PICTURE'	 => 'Изображение (desktop)',
						'PREVIEW_PICTURE'	 => 'Изображение (mobile)',
						'PROPERTY_LINK'		 => 'Ссылка',
				),
				'Статистика|cedit1'	 =>
				array(
						'PROPERTY_DATE_LAST_SHOW'	 => 'Дата последнего показа',
						'PROPERTY_COUNT_SHOW'		 => 'Количество показов',
						'PROPERTY_COUNT_CLICK'		 => 'Количество кликов',
				),
		));
				...
				array(
						...
						array(
								...
								array(
										...
										3	 => 'DETAIL_PICTURE',
										4	 => 'PROPERTY_LINK',
										5	 => 'PROPERTY_DATE_LAST_SHOW',
										6	 => 'PROPERTY_COUNT_SHOW',
										7	 => 'PROPERTY_COUNT_CLICK',
										8	 => 'ID',
										9	 => 'NAME',
								),
								'columns_sizes'		 =>
